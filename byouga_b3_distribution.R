...
# 2. 全てのデータフレームを縦に結合
df_combined <- bind_rows(df_base, df_015, df_03, df_045)
...
for (g_name in group_names) {
  ...
  # 4-3. ファイル名の定義と保存
  filename <- paste0("alpha_beta_distribution_", g_name, ".png")
...
# # ファイル名と保存
 all_filename <- paste0("alpha_beta_distribution_", "all", ".png")
