...
df_base_prep <- df_mm_base %>% mutate(round = 1:10, dataset = "base")
df_015_prep <- df_mm_015 %>% mutate(round = 1:10, dataset = "015")
df_03_prep <- df_mm_03 %>% mutate(round = 1:10, dataset = "03")
df_045_prep <- df_mm_045 %>% mutate(round = 1:10, dataset = "045")
...
for (dset in datasets) {
  ...
  filename <- paste0(save_dir, dset, "_fc_fr_combined_trend.png")
