...
df_045_long <- process_df(df_045, "Group 045")

# 3つのデータフレームを結合
combined_df <- bind_rows(df_base_long,df_015_long,df_03_long,df_045_long )
...
all_trend <- paste0(save_dir, "full_contribute_trend_alltreatment.png")
ggsave(
  filename = all_trend,  
  plot = plot_contribution_trend, 
  device = "png", 
  width = 8, 
  height = 5, 
  units = "in"
