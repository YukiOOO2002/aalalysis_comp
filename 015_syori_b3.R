...
path_1st <- "015/Oct29_1030_015_1st/b3_socialPt_2025-10-29_1030.csv"
df_1st <- read_csv(path_1st, show_col_types = FALSE)
path_2nd <- "015/Oct29_1330_015_2nd/b3_socialPt_2025-10-29_1330.csv"
...
write.csv(df_wide2, 
          file = "015/cleaning/b3syori_merge_015.csv",
          row.names = FALSE,   
          quote = TRUE )
