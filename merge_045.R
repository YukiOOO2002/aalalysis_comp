...
df_combined <- df_combined %>%
  ...
  mutate(
    participant.label = paste0("045", participant.label)
  )
...
write.csv(
  df_wide2, 
  file = "015/cleaning/merge_045.csv",
  row.names = FALSE,   
  quote = FALSE       
)
