...
# --- ファイルパスの設定 (環境に応じて変更してください) ---

# macOS/Linux環境ではCHROMOTE_CHROMEの設定は不要な場合が多いです。
# Windows環境でgtsaveが動作しない場合は、パスを確認してください。
# Sys.setenv(CHROMOTE_CHROME = "C:/Users/FMV/AppData/Local/Google/Chrome/Application/chrome.exe") 

# 作業ディレクトリとデータファイルパスの設定
setwd("C:/Users/FMV/OneDrive - OUMail (Osaka University)/デスクトップ") # 適切なパスに変更
