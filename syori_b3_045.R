...
path_1st <- "015/Nov10_1030_045_1st/b3_socialPt_2025-11-10_1030.csv"
df_1st <- read_csv(path_1st, show_col_types = FALSE)
path_2nd <- "015/Nov10_1330_045_2nd/b3_socialPt_2025-11-10_1330.csv"
...
write.csv(df_wide2, 
          file = "015/cleaning/b3syori_merge_045.csv",
          row.names = FALSE,   
          quote = TRUE )
