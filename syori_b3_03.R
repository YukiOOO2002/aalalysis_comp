...
path_1st <- "015/Nov05_1030_03_1st/b3_socialPt_2025-11-05_1030.csv"
df_1st <- read_csv(path_1st, show_col_types = FALSE)
path_2nd <- "015/Nov05_1330_03_2nd/b3_socialPt_2025-11-05_1330.csv"
...
df_combined <- df_combined %>%
  ...
  mutate(
    participant.label = paste0("03", participant.label)
  )
...
write.csv(df_wide2, 
          file = "015/cleaning/b3syori_merge_03.csv",
          row.names = FALSE,   
          quote = TRUE )
