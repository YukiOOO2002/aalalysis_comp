...
pathq1 <- "015/Oct29_1030_015_1st/q_2025-10-29_1030.csv"
df_q1 <- read_csv(pathq1, show_col_types = FALSE)
pathq2 <- "015/Oct29_1330_015_2nd/q_2025-10-29_1330.csv"
df_q2 <- read_csv(pathq2, show_col_types = FALSE)
df_q2 <- subset(df_q2, participant._current_page_name == "final")
pathb3 <- "015/cleaning/b3syori_merge_015.csv"
...
write.csv(
  df_wide2, 
  file = "015/cleaning/merge_015.csv",
  row.names = FALSE,   
  quote = FALSE       
)
