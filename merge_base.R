...
path_2nd <- "015/Nov06_1030_base_2nd/comp_demo_base_2025-11-06.csv"
...
df_wide2[, paste0("round ", 1:10, "_mpcr")] <- 0.6

write.csv(
  df_wide2, 
  file = "015/cleaning/merge_base.csv",
  row.names = FALSE,   
  quote = FALSE       
)
